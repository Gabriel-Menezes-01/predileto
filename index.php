...
<head>
  ...
  <link rel="stylesheet" href="../predileto/css/inicio.css">
    <link rel="stylesheet" href="../predileto/css/phone.css">
    <link rel="stylesheet" href="../predileto/css/alerts.css">
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.13.1/font/bootstrap-icons.min.css">
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/lipis/flag-icons@7.3.2/css/flag-icons.min.css">
    <link rel="stylesheet" href="../predileto/css/footer.css">
...
<main class="mainInicio">
        ...
        <div class="hero-container">
            ...
            <div class="hero-image">
                <div class="hero-image-wrapper">
                    <img src="../predileto/images/gallery/predileto.jpg" alt="Interior acolhedor do restaurante Predileto com iluminação ambiente">
    ...
    <section class="history-section" id="sobre">
        <div class="history-grid">
            <div class="history-image">
                <img src="../predileto/images/gallery/predileto2.jpg" alt="Mesas postas no restaurante Predileto">
            </div>
        ...
        <div class="dishes-grid">
            <div class="dish-card">
                <div class="dish-image">
                    <img src="../predileto/images/gallery/arrozdepato.jpg" alt="Prato 1">
                </div>
            ...
            <div class="dish-card">
                <div class="dish-image">
                    <img src="../predileto/images/gallery/salmao.jpg" alt="Prato 2">
                </div>
                <div class="dish-content">
                    <div class="dish-header">
                        <h3 class="dish-name">Lorem Epsum</h3>
            ...
            <div class="dish-card">
                <div class="dish-image">
                    <img src="../predileto/images/gallery/picanha.jpg" alt="Prato 3">
                </div>
                <div class="dish-content">
                    <div class="dish-header">
                        <h3 class="dish-name">Lorem Epsum</h3>
            ...
            <div class="testimonials-grid">
                <div class="testimonial-card">
                    <div class="testimonial-header-card">
                        <img src="../predileto/images/gallery/cliente1.jpg" alt="Foto de Daniyel Spyra" class="testimonial-avatar">
                ...
                <div class="testimonial-card">
                    <div class="testimonial-header-card">
                        <img src="../predileto/images/gallery/cliente2.jpg" alt="Foto de Natasha D" class="testimonial-avatar">
                        <div class="testimonial-info">
                ...
                <div class="testimonial-card">
                    <div class="testimonial-header-card">
                        <img src="../predileto/images/gallery/cliente3.jpg" alt="Foto de Jack Sparrow" class="testimonial-avatar">
                        <div class="testimonial-info">
    ...
    <div id="confirmationModal" class="modal-overlay">
        <div class="modal-content">
            ...
            <a href="../predileto/index.php" class="modal-btn">Volta o Início</a>
        </div>
    </div>
</main>

<?php include "../predileto/components/footer.php" ?>

    <script defer src="../predileto/js/alerts.js"></script>
    <script defer src="../predileto/js/phone-country.js"></script>
  <script defer src="../predileto/js/header.js"></script>
  <script defer src="../predileto/js/reservation.js"></script>
    <script defer src="../predileto/js/footer.js"></script>
</body>
</html>
